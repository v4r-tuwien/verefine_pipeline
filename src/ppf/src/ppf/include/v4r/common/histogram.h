 ...
 */
 void computeHistogram(const Eigen::MatrixXf &data, Eigen::MatrixXi &histogram, size_t bins = 100,
 ...
 */
 int computeHistogramIntersection(const Eigen::VectorXi &histA, const Eigen::VectorXi &histB);
 ...
 */
 void shiftHistogram(const Eigen::VectorXi &hist, Eigen::VectorXi &hist_shifted,
 ...
 */
 Eigen::VectorXf specifyHistogram(const Eigen::VectorXf &input_image, const Eigen::VectorXf &desired_image,
