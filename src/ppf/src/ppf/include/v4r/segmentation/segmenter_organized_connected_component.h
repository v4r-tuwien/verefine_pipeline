...
class OrganizedConnectedComponentSegmenter : public Segmenter<PointT> {
 ...
 public:
  explicit OrganizedConnectedComponentSegmenter(const SegmenterParameter &p = SegmenterParameter()) : param_(p) {}
